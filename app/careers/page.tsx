...
export const metadata: Metadata = {
  title: 'Careers',
  description: 'Learn about open roles at FerSil Ventures and within the portfolio.'
};
    ...
    <div className="py-16">
      <Container className="space-y-8 text-center">
        <SectionHeading
          ...
          description="We are building a pipeline of future roles at FerSil Ventures and across the portfolio. Share your details and we will be in touch as positions open."
        />
