  ...
  return (
    <div className="py-16">
      <Container className="space-y-12">
        <PageHero imageSrc="/media/backgrounds/companies-hero.png" imageAlt="FerSil companies page background with robotics and automation lab" contentClassName="max-w-3xl space-y-4">
